...
class PurePursuit(object):
    ...
    #waypiont callback function that we made, maybe
    def waypoint_callback(self, msg):
        self.latList.append(msg[0])
        self.lonList.append(msg[1])
        self.angleList.append(msg[2])
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.path_points_x = np.array(self.lonList) #changed from self.path_points_lon_x
            self.path_points_y = np.array(self.latList) #changed from self.path_points_lat_y
